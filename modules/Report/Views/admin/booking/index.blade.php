        ...
        <div class="filter-div d-flex justify-content-between">
            ...
            <div class="col-left">
                <form method="get" action="" class="filter-form filter-form-right d-flex justify-content-end">
                    <input type="text" name="date_range" class="form-control" id="date_range" value="{{ request()->query('date_range') }}" placeholder="{{ __('Select Date Range') }}" />
                    ...
                    <button class="btn-success btn btn-icon" name="export" value="1" type="submit"><i class="fa fa-file-export"></i>{{__('Export')}}</button>
                </form>
            </div>
        </div>
