    ...
    public function getOccupancyStatistics(Request $request)
{
    ...
    // Retrieve the total number of published rooms
    $totalRooms = Hotel::withCount(['rooms as published_rooms_count' => function ($query) {
        $query->where('status', 'publish');
    }])->get()->sum('published_rooms_count');

    // Prepare chart data (example structure; adapt as needed)
    $chartData = [
        'labels' => ['Total Bookings', 'Total Rooms'],
        'datasets' => [
            [
                'label' => __('Occupancy Statistics'),
                'data' => [$totalBookings, $totalRooms],
                'backgroundColor' => ['#4e73df', '#1cc88a'],
            ],
        ],
    ];

    // Detail data for display in chart legends or detail section
    $detailData = [
        ['title' => __('Total Bookings'), 'val' => $totalBookings],
        ['title' => __('Total Rooms'), 'val' => $totalRooms],
    ];
