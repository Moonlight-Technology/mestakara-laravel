...
<body>
    ...
    <div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2 parahero">
        <!-- Parallax Images -->
        <img src="{{ asset('assets/img/0.png') }}" alt="Layer 0" class="last-img">
        <img src="{{ asset('assets/img/2.png') }}" alt="Layer 3" class="para-img">
        <img src="{{ asset('assets/img/1.png') }}" alt="Layer 1" class="mid-img">
        <img src="{{ asset('assets/img/4.png') }}" alt="Layer 2" class="leaf-img">
        ...
        <div class="container space-2 space-top-xl-4 foreground-content">
            <div class="row justify-content-center pb-xl-8">
                <div class="py-8 py-xl-10 pb-5" style="opacity: 0">
                    <!-- <h1 class="font-size-60 font-size-xs-30 text-white font-weight-bold">{{$title ?? 'Title Goes Here'}}</h1>
                    <p class="font-size-20 font-weight-normal text-white">{{$sub_title ?? 'Subtitle Goes Here'}}</p> -->
                </div>
            </div>
