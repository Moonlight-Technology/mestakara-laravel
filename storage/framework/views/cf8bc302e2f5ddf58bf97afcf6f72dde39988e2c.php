                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th width="100px"> <?php echo e(__('Weekday')); ?></th>
                                        <th width="100px"> <?php echo e(__('Weekend')); ?></th>
                                    ...
                                    <?php if($rows->total() > 0): ?>
                                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="<?php echo e($row->status); ?>">
                                                ...
                                                <td><?php echo e(isset($row->weekend_price) ? format_money($row->weekend_price) : '-'); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1595410/public_html/modules/Hotel/Views/admin/room/index.blade.php ENDPATH**/ ?>