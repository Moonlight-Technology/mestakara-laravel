            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Mestakara CMS by')); ?> <a href="<?php echo e(__('https://www.bookingcore.org')); ?>" target="_blank"><?php echo e(__('AdiDEV')); ?></a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH C:\xampp\htdocs\mestakara\modules/Layout/admin/app.blade.php ENDPATH**/ ?>