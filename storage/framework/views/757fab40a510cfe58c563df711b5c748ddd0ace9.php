    ...
    <div class="mb-5 shadow-soft bg-white rounded-sm">
        <div class="pt-4 pb-5 px-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 mb-4">
                    <?php
                        $term_conditions = 'https://mestakara.id/page/privacy-policy';
                    ?>
                    <div class="mb-3">
                        <div class="custom-control custom-checkbox d-flex align-items-center text-muted">
                            ...
                            <label class="custom-control-label" for="termsCheckbox">
                                <small>
                                    ...
                                    <a target="_blank" class="link-muted" href="<?php echo e($term_conditions); ?>"><?php echo e(__('Terms and Conditions')); ?></a>
                                </small>
                            </label>
                        </div>
...
<?php /**PATH /home/u301264826/domains/mestakara.com/public_html/mestakara/themes/Mytravel/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>