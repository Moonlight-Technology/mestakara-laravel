...
<div class="form-group">
    <label><?php echo e(__("Location Code")); ?></label>
    <input type="text" value="<?php echo e($row->location_code); ?>" placeholder="<?php echo e(__("Location Code")); ?>" name="location_code" class="form-control">
</div>
...
</div><?php /**PATH /home/u1595410/public_html/modules/Location/Views/admin/form.blade.php ENDPATH**/ ?>