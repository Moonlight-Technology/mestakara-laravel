<?php if(!is_api()): ?>
    ...
    <div class="chat-box">
        ...
        <input type="text" name="" id="" class="chat-input" placeholder="Type Message.....">
    </div>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\mestakara\themes/Mytravel/Layout/parts/footer.blade.php ENDPATH**/ ?>