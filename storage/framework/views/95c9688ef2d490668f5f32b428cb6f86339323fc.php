        ...
        <div class="bravo-list-item">
            <div class="d-flex justify-content-between align-items-center mb-4 topbar-search">
                <h3 class="font-size-21 font-weight-bold mb-0 text-lh-1">
                    <?php if($rows->total() > 1): ?>
                        <?php echo e(__(":count resorts found",['count'=>$rows->total()])); ?>

                    <?php else: ?>
                        <?php echo e(__(":count resort found",['count'=>$rows->total()])); ?>
            ...
            <div class="list-item">
                    ...
                    <?php else: ?>
                            <?php echo e(__("Resort not found")); ?>
...
<?php /**PATH /home/u301264826/domains/mestakara.com/public_html/mestakara/themes/Mytravel/Hotel/Views/frontend/layouts/search/list-item.blade.php ENDPATH**/ ?>